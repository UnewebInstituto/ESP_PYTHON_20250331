...
COPY pago_movil FROM 'C:/ESP_PYTHON_20250331/NIVEL_II/HENRY/K40L410_250505.csv' WITH (FORMAT csv);
...
COPY temp_pagos FROM 'C:/ESP_PYTHON_20250331/NIVEL_II/henry/K40L410_250505_clean.txt';
