...
def persona_exportar_excel(request):
    ...
    EXPORT_DIR = r"C:\ESP_PYTHON_20250331\NIVEL_V\DANNYSA\excel" # La 'r' es para raw string, evita problemas con barras invertidas
